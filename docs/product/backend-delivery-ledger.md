...
Status: reviewed against `main` at `f01396a` on 2026-09-21.
...
| Application inventory, source revisions, and change impact | [#249](https://github.com/bdgrz/compliance/pull/249), [#250](https://github.com/bdgrz/compliance/pull/250), [#252](https://github.com/bdgrz/compliance/pull/252) | [EN-05 #195](https://github.com/bdgrz/compliance/issues/195), [R1-10b #213](https://github.com/bdgrz/compliance/issues/213), and [R1-10d #217](https://github.com/bdgrz/compliance/issues/217) retain import provenance, authorization, failure recovery, and complete projection proof. |
...
The first implementation bundle after the ledger is the dependency-ordered
R1-15 proof bundle: #152, #157, and #158. Work in one branch and one reviewable
PR where the contracts and split-host proof are shared. Keep #126, #123, and
#139 visible as blockers until their organization-specific or canonical-model
questions are resolved. The next independent backend slice is the operator
inventory in [R1-15a #238](https://github.com/bdgrz/compliance/issues/238), now
unblocked by Fitz .NET 1.4.1; it must not be reported complete until its
tenant-scoped HTTP/MCP and projection evidence exists.
