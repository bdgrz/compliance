...
public sealed class UserRegistrationWebTests
{
    [Fact]
    public async Task ShouldRequireAuthenticationGivenOidcRegistration()
    {
        // Arrange
    ...
    [Fact]
    public async Task ShouldRegisterAndEstablishSessionGivenDevelopmentAuthentication()
    {
        // Arrange
        ...
        // Act
        using var response = await client.PostAsJsonAsync(
            "/api/v1/developer-user-identities",
            submission,
            CancellationToken.None);
    ...
    [Fact]
    public async Task ShouldUseSameIdentityGivenEquivalentEmailRegistration()
    {
        // Arrange
        await using var factory = CreateFactory();
    ...
    [Fact]
    public async Task ShouldRejectInvalidEmailGivenRegistration()
    {
        // Arrange
        await using var factory = CreateFactory();
        using var client = factory.CreateClient();
