...
{
    [Fact]
    public void ExistingRegistrationEventsRemainActiveWithoutAnInvitation()
    {
    ...
    [Fact]
    public void ExistingDirectoryRowsDefaultToActive()
    {
        var tenantId = Uuid.CreateVersion4();
    ...
    [Fact]
    public void ExistingMembershipEventsDefaultToClientPersonnel()
    {
        var tenantId = Uuid.CreateVersion4();
