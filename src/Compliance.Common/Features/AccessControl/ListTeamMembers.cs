...
///     member-ID <em>prefix</em> (not a substring); <c>Sort</c> is <c>"member_id"</c> or
///     <c>"member_id:desc"</c> — members have exactly one index, so anything containing
///     <c>"desc"</c> reverses it.
/// </summary>
