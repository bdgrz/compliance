        ...
        switch (domainEvent)
        {
            case ApplicationDeclared declared:
                await ApplicationDirectorySchema.Applications.InsertAsync(Transaction,
                    new ApplicationView(declared.TenantId, declared.ApplicationId, 1,
                        declared.Name, declared.Purpose, declared.OwnerReference,
                        "manual", declared.ApplicationId.ToString(), false,
                        Gaps(declared.OwnerReference, false), declared.ActorMemberId,
                        declared.ActorDisplay, declared.ChangedAt), ct).ConfigureAwait(false);
                break;
            ...
            case SystemInstanceDeclared instance:
                ...
                await ApplicationDirectorySchema.Instances.InsertAsync(Transaction,
                    new SystemInstanceView(instance.TenantId, instance.ApplicationId,
                        instance.SystemInstanceId, instance.Name, instance.Kind,
                        instance.AccessBoundaryReference, "manual",
                        ...
                        instance.ActorMemberId,
                        instance.ActorDisplay, instance.ChangedAt), ct).ConfigureAwait(false);
