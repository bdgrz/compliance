...
public sealed class GrantPlatformOperatorHandler(IAggregateExecutor executor, TimeProvider clock)
    : IRequestHandler<GrantPlatformOperator>
{
    public ValueTask<Result> HandleAsync(IRequestContext<GrantPlatformOperator> context,
        CancellationToken ct)
    {
