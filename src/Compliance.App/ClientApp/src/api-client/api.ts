...
import type { AssignTeamMemberPath, DefineTeamPath, DeleteTeamPath, GetTeamPath, ListTeamMembersPath, ListTeamMembersQuery, ListTeamsPath, ListTeamsQuery, RemoveTeamMemberPath, RequestTenantSlugSurrenderPath } from "./operations";
